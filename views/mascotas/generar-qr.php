...
<head>
    ...
    <title>DR. WOOF - Generar QR Manchas</title>
            ...
            <div class="row row-sm justify-content-center">
                <div class="col-md-6 col-lg-5">
                    <div class="card shadow-base bd-0 pd-40 text-center">
                        ...
                        <p class="tx-13 mg-b-30">Escanea este código para acceder al historial médico de <strong>Manchas</strong> de forma inmediata.</p>
