  ...
  <div class="br-header-right">
    ...
    <div class="br-mainpanel">
      ...
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Cartilla Digital: Manchas</h4>
        <p class="mg-b-0">Registro oficial de inmunizaciones aplicadas.</p>
      </div>
        ...
        <div class="br-section-wrapper shadow-base bd-0">
          <div class="table-responsive">
            <table class="table table-bordered table-colored table-info">
              ...
              <tbody>
                <tr>
                  <td><strong>Parvovirus / Moquillo</strong></td>
                  <td>15 de Enero, 2026</td>
                  <td>15 de Enero, 2027</td>
                  <td class="text-center"><span class="badge badge-success">Aplicada</span></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td><strong>Pentavalente (Refuerzo)</strong></td>
                  <td>10 de Noviembre, 2025</td>
                  <td>10 de Noviembre, 2026</td>
                  <td class="text-center"><span class="badge badge-success">Aplicada</span></td>
                </tr>
                <tr>
                  <td><strong>Bordetella</strong></td>
                  <td>---</td>
