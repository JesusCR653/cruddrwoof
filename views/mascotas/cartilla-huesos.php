...
<head>
    ...
    <title>DR. WOOF - Cartilla de Vacunación Huesos</title>
  ...
  <div class="br-header-right">
    ...
    <div class="br-mainpanel">
      ...
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Cartilla Digital: Huesos</h4>
        <p class="mg-b-0">Esquema de vacunación para cachorro Golden Retriever.</p>
      </div>
        ...
        <div class="br-section-wrapper shadow-base bd-0">
          <div class="table-responsive">
            <table class="table table-bordered table-colored table-info">
              ...
              <tbody>
                <tr>
                  <td><strong>Puppy (Parvo + Moquillo)</strong></td>
                  <td>15 de Febrero, 2026</td>
                  <td>---</td>
                  <td class="text-center"><span class="badge badge-success">Completada</span></td>
                </tr>
                <tr>
                  <td><strong>Refuerzo Parvo/Moquillo</strong></td>
                  <td>10 de Marzo, 2026</td>
                  <td>---</td>
                  <td class="text-center"><span class="badge badge-success">Completada</span></td>
                </tr>
                <tr>
                  <td><strong>Vacuna Triple</strong></td>
                  <td>---</td>
                  <td>16 de Abril, 2026</td>
                  <td class="text-center"><span class="badge badge-warning">Próxima</span></td>
                </tr>
                <tr>
                  <td><strong>Rabia (Inicial)</strong></td>
                  <td>---</td>
                  <td>Mayo, 2026</td>
                  <td class="text-center"><span class="badge badge-secondary">Pendiente</span></td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div class="mg-t-30 text-right">
            <button class="btn btn-secondary pd-x-30" onclick="window.location.href='huesos-historial.html'">Regresar</button>
            <button class="btn btn-info pd-x-30 mg-l-5"><i class="fa fa-print mg-r-5"></i> Imprimir</button>
          </div>
        </div>
      </div>
    </div>
