  ...
  <div class="br-header-right">
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <a class="breadcrumb-item" href="perro-info.html">Manchas</a>
          ...
          <div class="row">
                ...
                <div class="row mg-b-25">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input id="editNombre" class="form-control" type="text" value="Manchas">
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label class="form-control-label">Raza:</label>
                      <input id="editRaza" class="form-control" type="text" value="Husky">
                    </div>
                  </div>
                  <div class="col-lg-6 mg-t-20">
                    <div class="form-group">
                      <label class="form-control-label">Edad:</label>
                      <input id="editEdad" class="form-control" type="text" value="4 años">
                    </div>
                  </div>
                  <div class="col-lg-6 mg-t-20">
                    <div class="form-group">
                      <label class="form-control-label">Tratamiento:</label>
                      <textarea id="editTratamiento" rows="3" class="form-control">Multivitamínico diario y cuidados de pelaje.</textarea>
                    </div>
                  </div>
                </div>
                <div class="form-layout-footer text-right">
                  <button class="btn btn-info pd-x-25" onclick="guardarCambios()">Guardar Cambios</button>
                  <a href="perro-info.html" class="btn btn-secondary pd-x-25 mg-l-5">Cancelar</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4 text-center mg-t-30 mg-md-t-0">
                <div class="card bd-0 shadow-base">
                    <img class="card-img-top img-fluid" src="public/img/husky.png" alt="Husky">
                    <div class="card-body bg-gray-100">
                        <button class="btn btn-outline-info btn-block btn-sm">Actualizar Foto</button>
                    </div>
                </div>
            </div>
          </div>
    ...
    <script>
        function guardarCambios() {
            localStorage.setItem('nombreCanino', document.getElementById('editNombre').value);
            localStorage.setItem('razaCanino', document.getElementById('editRaza').value);
            localStorage.setItem('edadCanino', document.getElementById('editEdad').value);
            localStorage.setItem('tratamientoCanino', document.getElementById('editTratamiento').value);
            
            alert('Información de Manchas actualizada');
            window.location.href = 'perro-info.html';
        }
    </script>
</body>
</html>