...
<head>
    ...
    <title>DR. WOOF - Editar Huesos</title>
...
<div class="br-header">
  ...
  <div class="br-header-right">
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <a class="breadcrumb-item" href="huesos-info.html">Huesos</a>
          <span class="breadcrumb-item active">Editar Información</span>
        </nav>
      </div>

      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Editar Información de Huesos</h4>
        <p class="mg-b-0">Actualiza los datos de tu Golden Retriever.</p>
      </div>
          ...
          <div class="row">
                ...
                <div class="row mg-b-25">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input id="editNombreHuesos" class="form-control" type="text" value="Huesos">
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label class="form-control-label">Raza:</label>
                      <input id="editRazaHuesos" class="form-control" type="text" value="Golden Retriever">
                    </div>
                  </div>
                  <div class="col-lg-6 mg-t-20">
                    <div class="form-group">
                      <label class="form-control-label">Edad:</label>
                      <input id="editEdadHuesos" class="form-control" type="text" value="8 meses">
                    </div>
                  </div>
                  <div class="col-lg-12 mg-t-20">
                    <div class="form-group">
                      <label class="form-control-label">Tratamiento:</label>
                      <textarea id="editTratamientoHuesos" rows="3" class="form-control">Esquema de vacunación inicial completo. Dieta para cachorros de raza grande.</textarea>
                    </div>
                  </div>
                </div>
                <div class="form-layout-footer text-right">
                  <button class="btn btn-info pd-x-25" onclick="guardarHuesos()">Guardar Cambios</button>
                  <a href="huesos-info.html" class="btn btn-secondary pd-x-25 mg-l-5">Cancelar</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4 text-center mg-t-30 mg-md-t-0">
                <div class="card bd-0 shadow-base">
                    <img class="card-img-top img-fluid" src="https://images.unsplash.com/photo-1552053831-71594a27632d?auto=format&fit=crop&q=80&w=400" alt="Huesos">
                    <div class="card-body bg-gray-100">
                        <button class="btn btn-outline-info btn-block btn-sm">Cambiar Foto</button>
                    </div>
                </div>
            </div>
          </div>
    ...
    <script>
        function guardarHuesos() {
            localStorage.setItem('nombreHuesos', document.getElementById('editNombreHuesos').value);
            localStorage.setItem('razaHuesos', document.getElementById('editRazaHuesos').value);
            localStorage.setItem('edadHuesos', document.getElementById('editEdadHuesos').value);
            localStorage.setItem('tratamientoHuesos', document.getElementById('editTratamientoHuesos').value);
            
            alert('Datos de Huesos actualizados');
            window.location.href = 'huesos-info.html';
        }
    </script>
</body>
</html>