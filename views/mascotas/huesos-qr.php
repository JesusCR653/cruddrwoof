...
<head>
    ...
    <title>DR. WOOF - Generar QR Huesos</title>
...
<li class="nav-item">
  ...
  <ul class="br-menu-sub nav flex-column">
    ...
    <li class="nav-item"><a href="index.php?menu=mascotas&opc=huesos-qr" class="nav-link active">Qr</a></li>
    ...
    <div class="br-mainpanel">
        <div class="br-pageheader pd-y-15 pd-l-20">
            <nav class="breadcrumb pd-0 mg-0 tx-12">
                ...
                <span class="breadcrumb-item active">Generar QR</span>
            </nav>
        </div>

        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
            <h4 class="tx-gray-800 mg-b-5">Identificador Digital Canino</h4>
            <p class="mg-b-0">Genera el código único para la placa de tu mascota.</p>
        </div>

        <div class="br-pagebody">
            <div class="row row-sm justify-content-center">
                <div class="col-md-6 col-lg-5">
                    <div class="card shadow-base bd-0 pd-40 text-center">
                        <h5 class="tx-inverse tx-bold mg-b-20">Código de Identificación</h5>
                        <p class="tx-13 mg-b-30">Escanea este código para acceder al historial médico de <strong>Huesos</strong> de forma inmediata.</p>
                        
                        <div class="bg-gray-200 pd-40 mg-b-30 rounded d-inline-block mx-auto">
                            <i class="fa fa-qrcode tx-150 lh-0 tx-gray-800"></i>
                        </div>

                        <div class="d-flex justify-content-center">
                            <button class="btn btn-primary pd-x-25 mg-r-10" onclick="$('#successModal').modal('show')">
                                <i class="fa fa-refresh mg-r-10"></i> Generar Nuevo
                            </button>
                            <button class="btn btn-outline-secondary pd-x-25">
                                <i class="fa fa-print mg-r-10"></i> Imprimir Placa
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content tx-size-sm">
                <div class="modal-body tx-center pd-y-20 pd-x-20">
                    ...
                    <p class="mg-b-20 mg-x-20">El código único para <strong>Huesos</strong> ha sido creado exitosamente y está listo para imprimirse.</p>
                    <button type="button" class="btn btn-success tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20" data-dismiss="modal">
                        Aceptar
                    </button>
                </div>
            </div>
