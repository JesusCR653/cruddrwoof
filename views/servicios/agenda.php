...
<head>
    ...
    <style>
        ...
        .fc-datepicker { background-color: #fff; border: 1px solid #ced4da; }
        .event-marked { 
        ...
        <div class="row">
          <div class="col-md-8">
            <div class="br-section-wrapper shadow-base bd-0">
              <h6 class="tx-inverse tx-uppercase tx-bold tx-14 mg-b-20">Calendario de Citas</h6>
              <div class="datepicker-placeholder text-center pd-y-40">
                  <p class="tx-bold tx-inverse tx-18">Abril 2026</p>
                  <table class="table table-bordered bg-white mg-t-20 text-center">
                      <thead>
                      ...
                      <tbody>
                          ...
                          <tr><td>12</td><td>13</td><td>14</td><td class="event-marked">15</td><td>16</td><td>17</td><td>18</td></tr>
          ...
          <div class="col-md-4">
            <div class="card bd-0 shadow-base pd-20">
              <h6 class="tx-inverse tx-uppercase tx-bold tx-13 mg-b-20">Próximas Citas</h6>
              <div class="media">
                <div class="wd-40 ht-40 bg-success tx-white d-flex align-items-center justify-content-center rounded tx-bold">15</div>
                <div class="media-body mg-l-15">
                  <p class="mg-b-0 tx-inverse tx-bold">Manchas - Revisión</p>
                  <p class="tx-12 mg-b-0 text-info">10:30 AM</p>
                </div>
              </div>
            </div>
          </div>
